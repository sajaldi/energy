...
# TODO: Temporalmente deshabilitado hasta configurar Playwright en producción
...
def sync_tickets_task(days=2):
    ...
    NOTA: Temporalmente deshabilitada - requiere configurar Playwright en producción.
    """
    logger.warning("La sincronización automática está temporalmente deshabilitada. Se requiere configurar Playwright en el servidor.")
    return {"status": "error", "message": "Funcionalidad temporalmente deshabilitada - requiere Playwright"}
    
    # TODO: Descomentar cuando Playwright esté configurado
    # username = os.environ.get('CALLCENTER_USER', 'saul.alvarado')
    # password = os.environ.get('CALLCENTER_PASS', 'S@4l2689*')
