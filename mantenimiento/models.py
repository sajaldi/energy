...
class OrdenTrabajo(models.Model):
    ...
    tecnico = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='ordenes_asignadas', help_text="Usuario líder (requiere cuenta de sistema)")
    tecnico_puesto = models.ForeignKey(TecnicoPuesto, on_delete=models.SET_NULL, null=True, blank=True, related_name='ordenes_asignadas', verbose_name="Personal Responsable", help_text="Técnico asignado (con o sin usuario)")
    tecnicos = models.ManyToManyField(User, related_name='ordenes_colaboracion', blank=True, help_text="Equipo de técnicos asignados (Usuarios)")
    colaboradores_puesto = models.ManyToManyField(TecnicoPuesto, related_name='ordenes_colaboradas', blank=True, help_text="Equipo de técnicos asignados (Personal)")
