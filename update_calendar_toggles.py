    ...
    <div class="container">
        <table>
            ...
            <tbody>
                ...
                {% for r in f.rutinas %}
                <tr class="rutina-group-row dis-{{ forloop.parentloop.parentloop.parentloop.counter }} sub-{{ forloop.parentloop.parentloop.parentloop.counter }}-{{ forloop.parentloop.parentloop.counter }} frec-{{ forloop.parentloop.parentloop.counter }}-{{ forloop.parentloop.counter }}-{{ forloop.counter }} collapsed hidden"
                ...
                <tr
                    class="location-row dis-{{ forloop.parentloop.parentloop.parentloop.parentloop.counter }} sub-{{ forloop.parentloop.parentloop.parentloop.parentloop.counter }}-{{ forloop.parentloop.parentloop.parentloop.counter }} frec-{{ forloop.parentloop.parentloop.parentloop.counter }}-{{ forloop.parentloop.parentloop.counter }}-{{ forloop.parentloop.counter }} rut-{{forloop.parentloop.parentloop.parentloop.counter}}-{{forloop.parentloop.parentloop.parentloop.counter}}-{{forloop.parentloop.counter}}-{{forloop.counter}} hidden">
...
with open(r"d:\Apps\energia\energy\mantenimiento\templates\mantenimiento\calendario_detallado.html", "w", encoding="utf-8") as f:
    f.write(content)
os.remove(r"d:\Apps\energia\energy\restore_calendar.py")
