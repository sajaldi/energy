...
app.autodiscover_tasks(['mantenimiento', 'presupuestos', 'servicios', 'activos', 'callcenter', 'core', 'consultas'])
app.autodiscover_tasks(['servicios'], related_name='tasks_riesgos')
