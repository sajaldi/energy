...
def api_activo_detalle(request, activo_id):
    ...
    data = {
        ...
        'modelo_id': activo.modelo.id if activo.modelo else None,
        'modelo_descripcion': activo.modelo.descripcion if activo.modelo else None,
        'modelo_imagen': activo.modelo.imagen if activo.modelo else None,
...
def mobile_ubicaciones(request, parent_id=None):
    ...
    ).prefetch_related('categoria__mantenimiento_tipo').order_by('orden', 'nombre')
