...
urlpatterns = [
    ...
    path('api/biblioteca/vectorize/<int:bib_id>/', views.api_biblioteca_vectorize, name='api_biblioteca_vectorize'),
    path('api/biblioteca/mapa-datos/<int:bib_id>/', views.api_biblioteca_mapa_datos, name='api_biblioteca_mapa_datos'),
    path('api/vectorize/<int:doc_id>/', views.api_documento_vectorize_single, name='api_documento_vectorize_single'),
    path('espacio-vectorial/<int:doc_id>/', views.documento_espacio_vectorial, name='documento_espacio_vectorial'),
    path('api/espacio-vectorial/<int:doc_id>/', views.api_documento_espacio_datos, name='api_documento_espacio_datos'),
