...
urlpatterns = [
    ...
    path('listo-recoleccion/', views.listo_recoleccion_view, name='listo_recoleccion'),
    ...
    path('api/pedidos-listos-recoleccion/', views.api_pedidos_listos_recoleccion, name='api_pedidos_listos_recoleccion'),
    path('api/pedidos/<int:pk>/confirmar-entrega/', views.api_confirmar_entrega_almacen, name='api_confirmar_entrega_almacen'),
